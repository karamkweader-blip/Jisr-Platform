...
class CompanyConversationsView
    extends GetView<CompanyConversationController> {
  const CompanyConversationsView({
    super.key,
  });
  ...
  Widget _buildContent() {
    ...
    final error =
        controller.conversationsError.value;
    ...
    final visible =
        controller.visibleConversations;
    ...
    if (visible.isEmpty) {
      if (controller
        ...
        return const JisrEmptyState(
          ...
          title: 'لا توجد نتائج',
          message:
              'لم نعثر على محادثة مطابقة لبحثك.',
        );
      }
    ...
    switch (controller
      ...
      case CompanyConversationTab.all:
        return const JisrEmptyState(
          ...
          message:
              'لا توجد محادثات متاحة للشركة حاليًا.',
        );
      ...
      case CompanyConversationTab.closed:
        return const JisrEmptyState(
          ...
          message:
              'المحادثات التي تنتهي ستظهر هنا للرجوع إليها لاحقًا.',
        );
    }
  }
}
